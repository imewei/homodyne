...
**Version:** 2.22.4 **Last Updated:** March 2026 **Codebase:** ~87,700 lines Python + ~680 lines shell
...
├── _version.py                        # Auto-generated: "2.22.4"
│
...
import homodyne
    ...
    │
    ├── __version__ = "2.22.4"                       # From _version.py (setuptools_scm)
    │
