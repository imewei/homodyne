...
**Version:** 2.22.6 **Last Updated:** March 2026 **Codebase:** ~89,000 lines Python + ~780 lines shell
...
├── _version.py                        # Auto-generated: "2.22.6"
│
...
import homodyne
    ...
    │
    ├── __version__ = "2.22.6"                       # From _version.py (setuptools_scm)
    │
