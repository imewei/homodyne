...
**Single GPU (16GB)** | Sequential | 4× single-chain time | | **14-core CPU** | Parallel
| ~1.1× single-chain time |

**Trade-off**: Single GPU chains are sequential but provide critical convergence
diagnostics worth the 4× time cost.
...
|----------|--------|------|-------|-------------| | **CPU** | 4 | ✅ Parallel | ~1.1× |
✅ Full | | **1 GPU** | 4 | ⚠️ Sequential | 4× | ✅ Full | | **4 GPUs** | 4 | ✅ Parallel |
~1.1× | ✅ Full |
...
1. ✅ **ESS (Effective Sample Size)** - True independent sample count
1. ✅ **Divergence detection** - Identifies problematic regions
1. ✅ **Better uncertainty** - Cross-chain variance
...
| Criterion | NUTS (4 chains) | CMC | |-----------|-----------------|-----| | **Best
for** | < 100 samples | ≥ 100 samples or huge data | | **Single GPU speed** | 4×
single-chain | Parallel shards | | **Diagnostics** | Excellent (R-hat, ESS) | Basic | |
**Memory** | Dataset × 1 | Dataset / num_shards | | **Setup** | Simple | More complex |
...
|---------------|----------|---------------------| | 1 chain | 3 min | 12 min | | 2
chains | 6 min | 14 min | | 4 chains | 12 min | 15 min | | 8 chains | 24 min | 18 min |
