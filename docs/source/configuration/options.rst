...
.. code-block:: yaml
    ...
    metadata:
      config_version: "2.22.7"           # Configuration format version
...
See :doc:`/theory/anti_degeneracy_defense` for detailed documentation of the
...
.. code-block:: yaml
    ...
    output:
      ...
      create_subdirs: true              # Create method subdirs (nlsq/, cmc/)
...
.. table:: Quick Configuration Reference
   ...
   Static with CMC             analysis_mode: "static", method: "cmc"
   ...
   High precision CMC          num_samples: 10000, num_chains: 8
   ==========================  ===============================================
