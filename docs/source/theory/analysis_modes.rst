...
This is always evaluated numerically via **cumulative trapezoid** on the discrete time
...
This is always evaluated numerically via **cumulative trapezoid** on the discrete time
grid, matching the diffusion integral method (see :doc:`computational_methods`).
