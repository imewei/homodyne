    ...
    with patch.dict("sys.modules", {"jax": None, "jax.numpy": None}):
        with patch(
            ...
            try:
                ...
                print(
                    f"NumPy gradients available: {jax_backend.numpy_gradients_available}"
                )
                ...
                result = jax_backend.compute_g1_diffusion(
                    test_params, test_t1, test_t2, test_q
                )
                ...
                if jax_backend.numpy_gradients_available:
                    ...
                    def test_func(params):
                        return jax_backend.compute_g1_diffusion(
                            params, test_t1, test_t2, test_q
                        )[0]
