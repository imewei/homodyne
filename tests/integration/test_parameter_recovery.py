...
class TestParameterRecoveryAccuracy:
    ...
    def test_static_isotropic_parameter_recovery(self):
        ...
        for name in param_names:
            ...
            print(f"{name:12s}: True={true_val:10.4f}, "
    ...
    @pytest.mark.slow
    @pytest.mark.skip(reason="T035: Laminar flow parameter recovery requires more sophisticated test setup - 9-parameter fit is ill-conditioned with current synthetic data")
    def test_laminar_flow_parameter_recovery(self):
        ...
        # Extract recovered parameters
        param_names = ['contrast', 'offset', 'D0', 'alpha', 'D_offset',
                       'gamma_dot_t0', 'beta', 'gamma_dot_offset', 'phi0']
        recovered = dict(zip(param_names, result.parameters))
        ...
        for name in param_names:
            ...
            print(f"{name:18s}: True={true_val:10.6f}, "
