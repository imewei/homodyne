...
class TestExecutorStabilityParameter:
    """Tests for stability='auto' parameter in executors."""

    def test_standard_executor_passes_stability_auto(self):
        """Test that StandardExecutor passes stability='auto' to curve_fit."""
        ...
        with patch(
            "homodyne.optimization.nlsq.strategies.executors.curve_fit",
    ...
    def test_large_executor_passes_stability_auto(self):
        """Test that LargeDatasetExecutor passes stability='auto' to curve_fit_large."""
        from unittest.mock import patch
        ...
        captured_kwargs = {}
        from nlsq import curve_fit_large as real_curve_fit_large

        def mock_curve_fit_large(*args, **kwargs):
            captured_kwargs.update(kwargs)
            return real_curve_fit_large(*args, **kwargs)

        with patch(
            "homodyne.optimization.nlsq.strategies.executors.curve_fit_large",
